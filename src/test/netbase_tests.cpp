...
{
    BOOST_CHECK(TestSplitHost("www.infinitecoin.org", "www.infinitecoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.infinitecoin.org]", "www.infinitecoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.infinitecoin.org:80", "www.infinitecoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.infinitecoin.org]:80", "www.infinitecoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9321", "127.0.0.1", 9321));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9321", "127.0.0.1", 9321));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9321", "::ffff:127.0.0.1", 9321));
    BOOST_CHECK(TestSplitHost("[::]:9321", "::", 9321));
    BOOST_CHECK(TestSplitHost("::9321", "::9321", -1));
    BOOST_CHECK(TestSplitHost(":9321", "", 9321));
    BOOST_CHECK(TestSplitHost("[]:9321", "", 9321));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9321", "127.0.0.1:9321"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9321", "[::]:9321"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
